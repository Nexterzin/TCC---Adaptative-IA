...
const RecoveryPasswordPage = () => {
    ...
    let [senhaRecuperadaSucesso, setsenhaRecuperadaSucesso] = useState(false);
                    ...
                    <Grid size={{ xs: 11, md: 6, lg: 6 }} >
                        <Conditional shoWhen={!senhaRecuperadaSucesso} >
                            ...
                            >
                                ...
                                <Grid size={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '10px' }}>
                                    <DefaultaButton
                                        onClick={() => setsenhaRecuperadaSucesso(true)}
                                        content={'Avançar'}
                                        widthButton='380px'
                                    />
                                </Grid>
                        ...
                        <Conditional shoWhen={senhaRecuperadaSucesso} >
                            ...
                            >
                                ...
                                <Grid size={12} >
                                    <Stack color={'rgba(255, 255, 255, 1)'} textAlign="center" className="labelForm">
